...
public class boardmanager extends JavaPlugin implements Listener{
    ...
    public static void Creation(){
        ...
        gametimer = objective.getScore(Bukkit.getOfflinePlayer(ChatColor.RED + "Game Timer:"));
    }
}
